...
function updateCounter() {
    ...
    let counterChecked = 0; //Zähler für erledigte Aufgaben
    let counterOpen = 0; //Zähler für offene Aufgaben
    //eine Schleife, um nach und nach durchzugehen, um zu schauen, ob true or false ist
    for (let i = 0; i < todos.length; i++) { //i als zählende Variable
